...
foreach ($records as $record) {
    ...
    // We want to number these in the 40000-49999 range
    $current_record_id = intval($record['record_id']);
    if ($current_record_id < 50000) $max_id = max($max_id, $current_record_id);
